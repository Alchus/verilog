...
size: .word  12             # size of "array" 
      ...
      addi $t2, $0 1           # 1 is first and second Fib. number
      nop
      sw   $t2, 0($t0)      # F[0] = 1
...
loop: lw   $t3, 0($t0)      # Get value from array F[n] 
      ...
      bne  $t1, $0 loop        # repeat if not finished yet.
...
print:add  $t0, $zero, $a0  # starting address of array
      ...
      addi $v0, $0, 4       # specify Print String service
      syscall               # print heading
out:  lw   $a0, 0($t0)      # load fibonacci number for syscall
      addi $v0,$0, 1        # specify Print Integer service
      ...
      addi $t1, $t1, -1     # decrement loop counter
      bne  $t1, $0, out     # repeat if not finished
      jr   $ra              # return
      add $0, $0, $0
